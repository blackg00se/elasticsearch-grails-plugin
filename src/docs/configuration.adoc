...
A string overriding the default ElasticSearch index naming strategy. If set to 'class', will default to the package name + package name of the domain in question - i.e. one index per domain class.
